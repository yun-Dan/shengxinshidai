...
function ExportUserSignCert(strCertID,cb, ctx){
    if ($_$CurrentObj != null) {
        return $_$CurrentObj.ExportUserSignCert(strCertID,cb, ctx);
    }
    return "";
...
function GetCertInfo(strCert, Type,cb, ctx){
    if ($_$CurrentObj != null) {
        return $_$CurrentObj.GetCertInfo(strCert, Type,cb, ctx);
    }
    return "";
...
export default {
    // SetAutoLogoutParameter:SetAutoLogoutParameter,
    // SetLoginCertID:SetLoginCertID,
    // SetLogoutFunction:SetLogoutFunction,
    // SetUserCertList:SetUserCertList,
    // SetOnUsbKeyChangeCallBack:SetOnUsbKeyChangeCallBack,
    // SetAlertFunction:SetAlertFunction,
    // $checkBrowserISIE:$checkBrowserISIE,
    // $popDropListBoxAll:$popDropListBoxAll,
    // $pushOneDropListBox:$pushOneDropListBox,
    // $pushAllDropListBox:$pushAllDropListBox,
    // $myAutoLogoutCallBack:$myAutoLogoutCallBack,
    // $OnUsbKeyChange:$OnUsbKeyChange,
    // $AttachIE11OnUSBKeychangeEvent:$AttachIE11OnUSBKeychangeEvent,
    // $XTXAlert:$XTXAlert,
    // CreateXTXAppObject:CreateXTXAppObject,
    // CreateSecXV2Object:CreateSecXV2Object,
    // CreateSecXObject:CreateSecXObject,
    // CreateWebSocketObject:CreateWebSocketObject,
    ...
    // GetExchCert:GetExchCert,
    VerifyUserPIN:VerifyUserPIN,
    // ChangeUserPassword:ChangeUserPassword,
    // GetUserPINRetryCount:GetUserPINRetryCount,

    // GetUserList_USBKey:GetUserList_USBKey,
    // GetUserList_Soft:GetUserList_Soft,
    // GetCertEntity,
    // VerifySignedData,
    // PubKeyEncrypt,
    // PriKeyDecrypt,
