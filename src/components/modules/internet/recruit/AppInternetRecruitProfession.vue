<template>
  <div
    class="app-internet-recruit-profession"
    v-loading="loading"
    ...
    <el-card class="box-card">
      ...
      <div class="news inform-main" v-cloak>
        ...
        >
          ...
          <el-table-column align="center" prop="platform" label="平台名称"></el-table-column>
          <el-table-column align="center" prop="url" label="平台网址"></el-table-column>
...
export default {
  name: "app-internet-recruit-profession",
  data() {
    return {
      loading: false,
