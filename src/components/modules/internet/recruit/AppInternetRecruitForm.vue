<template>
  <div class="app-internet-recruit-form" v-loading="loading">
    <el-form
      ...
      :label-width="query['3'] ? '140px' : '110px'"
    >
      ...
      <el-form-item label="平台名称：" :rules="[{required: !query['3']}]">
        <el-input v-model.trim="form.platform" :disabled="query['3']"></el-input>
      </el-form-item>
      <el-form-item label="平台网址：" :rules="[{required: !query['3']}]">
        <el-input v-model.trim="form.url" :disabled="query['3']"></el-input>
      </el-form-item>
      <el-form-item label="平台简介：" :rules="[{required: !query['3']}]">
        <el-input
      ...
      <el-form-item label="学费（元）：" :rules="[{required: !query['3']}]">
        <el-row :gutter="20">
          <el-col :span="8">
            ...
            >{{ new Date(form.date1).getFullYear() }} 年</div>
            <el-input-number
          ...
          <el-col :span="8">
            <div
              v-if="form.date1"
              class="text-align-center"
            >{{ new Date(form.date1).getFullYear() + 1 }} 年</div>
            <el-input-number
          ...
          <el-col :span="8">
            <div
              v-if="form.date1"
              class="text-align-center"
            >{{ new Date(form.date1).getFullYear() + 2 }} 年</div>
            <el-input-number
      ...
      <el-form-item label="招生章程文本：" :rules="[{required: !query['3']}]">
