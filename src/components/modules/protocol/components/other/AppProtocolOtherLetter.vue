<template>
  <div class="app-protocol-other-letter">
...
export default {
  name: "app-protocol-other-letter",
  data() {
    return {
      xy_time: null, // 创建协议时间
      showData: {},
      front: false, // false验证登录，true微信扫码查看
  ...
  methods: {
    ...mapActions(["getOtherProtocol", "checkWt"]),
    initData(id) {
