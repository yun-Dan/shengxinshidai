<template>
  <div class="app-protocol-college-letter">
    <div id="subOutputRank-print">
      <div class="commitment-content">
          ...
          <el-row>
            <el-col :span="12" :offset="6">
              <div class="grid-content bg-purple">
                <h2 style="text-align: center;line-height: 100px" class>培训承办单位承诺书</h2>
              </div>
            </el-col>
            <el-col :span="6">
              <div class="grid-content bg-purple">
        ...
        <div class>
          ...
          <div>
            <img src="../../../../../assets/images/wt.jpg" alt style="width: 100%">
          </div>
        </div>
      </div>
    </div>
    <div style="padding: 0 40px;text-align: center;margin-top: 40px" v-cloak>
...
export default {
  name: "app-protocol-college-letter",
  data() {
    return {
      showData: {},
      front: 0,
  ...
  methods: {
    ...mapActions(["getHzProtocol", "checkWt"]),
    initData(id) {
      if (!this.front) {
