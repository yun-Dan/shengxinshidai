<template>
  <div class="app-document-yngw-info" v-loading="loading">
      ...
      <div class="document-form-page-content">
        <div class="clearfix document-form-page-line">
          ...
          <div class="fl document-form-page-right" style="padding: 60px 0">
            <el-button
              v-if="userInfo.role === 1 && query['1'] && query['2']"
              type="success"
              size="small"
              plain
        ...
        <div class="clearfix document-form-page-line">
          ...
          <div class="fl document-form-page-center" style="width: 640px; color: #444">
            <template v-if="proConfig.document_type">
              <div v-if="query['3']">{{ proConfig.document_type[form.document_type] }}</div>
            </template>
          </div>
        </div>
        <div class="clearfix document-form-page-line">
          ...
          <div class="fl document-form-page-center" style="width: 240px; color: #444;">
            <span v-if="query['3']">{{ form.name }}</span>
          </div>
          <div class="fl document-form-page-cl">电&nbsp;&nbsp; 话</div>
          <div class="fl document-form-page-center" style="width: 240px; color: #444;">
            <span v-if="query['3']">{{ form.tel }}</span>
          </div>
        </div>
  ...
  methods: {
    ...
    initData() {
      ...
      if (this.query["4"] == -1) {
        ...
        this.query["4"] === 0 &&
        this.query["100"] &&
        sessionStorage.getItem("yulan_100")
      ) {
        // 预览
