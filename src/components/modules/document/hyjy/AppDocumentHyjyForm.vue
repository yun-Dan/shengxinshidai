<template>
  <div class="app-document-hyjy-form" v-loading="loading">
      ...
      <div class="document-form-page-content">
        ...
        <div class="clearfix document-form-page-line">
          ...
          <div class="fl document-form-page-center" style="width: 640px">
            <template v-if="proConfig.meeting_type">
              ...
              >
                <el-option
                  v-for="(item, key) in proConfig.meeting_type"
                  :label="item"
                  :value="key -0"
                  :key="key"
                ></el-option>
        ...
        <div class="clearfix document-form-page-line document-form-page-line-last">
          ...
          <div class="fl document-form-page-center" style="width: 640px; padding-top: 1px">
            <el-input v-model="form.title1" :disabled="query['3']" clearable placeholder="请输入标题">
              <i slot="prefix" class="el-input__icon el-icon-edit"></i>
            </el-input>
          </div>
        </div>
...
export default {
  ...
  methods: {
    ...
    initData() {
      ...
      if (this.query["4"] == -1) {
        this.loading = false;
        this.$set(this.form, "meeting_host", this.userInfo.realname);
        this.$set(this.form, "meeting_place", this.userInfo.tel);
    ...
    handlePreview(preview) {
      ...
      sessionStorage.setItem("yulan_99", JSON.stringify(Obj));
      if (preview === 1) {
        this.$router.push({
  ...
  mounted() {
    if (this.$refs.ue) {
      if (sessionStorage.getItem("yulan_99")) {
        // 继续编辑（从预览页返回编辑）
        this.keepEdit();
      } else {
        this.initData();
